...
set_property IOSTANDARD LVCM0S33 [get_ports {led[7]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[6]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[5]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[4]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[3]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[2]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[1]}]
set_property IOSTANDARD LVCM0S33 [get_ports {led[0]}]
set_property IOSTANDARD LVDS [get_ports clock_p]
set_property IOSTANDARD LVDS [get_ports clock_n]
set_property IOSTANDARD LVCM0S18 [get_ports reset]